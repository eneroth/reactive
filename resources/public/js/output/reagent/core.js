...
var render_component_to_string__1 = (function (component){var res = cljs.core.atom.call(null,null);render_component_to_string.call(null,component,(function (p1__9621_SHARP_){return cljs.core.reset_BANG_.call(null,res,p1__9621_SHARP_);
}));
...
var G__9622__delegate = function (x,rest){return cljs.core.apply.call(null,reagent.ratom.atom,x,rest);
};
...
partial.cljs$lang$applyTo = (function (arglist__9624){
...
;
var p1_9625 = reagent.core.partial.call(null,cljs.core.vector,1,2);if(cljs.core._EQ_.call(null,p1_9625.call(null,3),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [1,2,3], null)))
{} else
...
if(cljs.core._EQ_.call(null,p1_9625,reagent.core.partial.call(null,cljs.core.vector,1,2)))
{} else
...
if(cljs.core.ifn_QMARK_.call(null,p1_9625))
{} else
...
if(cljs.core._EQ_.call(null,reagent.core.partial.call(null,cljs.core.vector,1,2),p1_9625))
{} else
...
if(cljs.core.not_EQ_.call(null,p1_9625,reagent.core.partial.call(null,cljs.core.vector,1,3)))
{} else
