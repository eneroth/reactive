...
var G__9435__delegate = function (type,props,child,children){
if(!(cljs.core.map_QMARK_.call(null,props))){
} else {
throw (new Error([cljs.core.str("Assert failed: "),cljs.core.str(cljs.core.pr_str.call(null,cljs.core.list(new cljs.core.Symbol(null,"not","not",1044554643,null),cljs.core.list(new cljs.core.Symbol(null,"map?","map?",-1780568534,null),new cljs.core.Symbol(null,"props","props",2093813254,null)))))].join('')));
}
...
var _STAR_non_reactive_STAR_9438 = reagent.impl.component._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_9438;
}});
...
var _STAR_non_reactive_STAR_9440 = reagent.impl.component._STAR_non_reactive_STAR_;
try{reagent.impl.component._STAR_non_reactive_STAR_ = true;

return (React["renderToStaticMarkup"])(reagent.core.as_element.call(null,component));
}finally {reagent.impl.component._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_9440;
}});
...
wrap.cljs$lang$applyTo = (function (arglist__9443){
var value = cljs.core.first(arglist__9443);
arglist__9443 = cljs.core.next(arglist__9443);
var reset_fn = cljs.core.first(arglist__9443);
...
if((function (){var G__9446 = ra;
if(G__9446){
var bit__4304__auto__ = (G__9446.cljs$lang$protocol_mask$partition0$ & (32768));
if((bit__4304__auto__) || (G__9446.cljs$core$IDeref$)){
return true;
} else {
if((!G__9446.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IDeref,G__9446);
} else {
return false;
}
}
...
var G__9448__delegate = function (path,ra,reset_fn,args){
if((function (){var G__9447 = ra;
if(G__9447){
var bit__4304__auto__ = (G__9447.cljs$lang$protocol_mask$partition0$ & (32768));
if((bit__4304__auto__) || (G__9447.cljs$core$IDeref$)){
return true;
} else {
if((!G__9447.cljs$lang$protocol_mask$partition0$)){
return cljs.core.native_satisfies_QMARK_.call(null,cljs.core.IDeref,G__9447);
} else {
return false;
}
}
...
var G__9448 = function (path,ra,reset_fn,var_args){
var args = null;
if (arguments.length > 3) {
  args = cljs.core.array_seq(Array.prototype.slice.call(arguments, 3),0);
} 
return G__9448__delegate.call(this,path,ra,reset_fn,args);};
G__9448.cljs$lang$maxFixedArity = 3;
G__9448.cljs$lang$applyTo = (function (arglist__9449){
var path = cljs.core.first(arglist__9449);
arglist__9449 = cljs.core.next(arglist__9449);
var ra = cljs.core.first(arglist__9449);
arglist__9449 = cljs.core.next(arglist__9449);
var reset_fn = cljs.core.first(arglist__9449);
var args = cljs.core.rest(arglist__9449);
return G__9448__delegate(path,ra,reset_fn,args);
});
...
partial.cljs$lang$applyTo = (function (arglist__9450){
...
//# sourceMappingURL=core.js.map?rel=1418725957633