...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t12536 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t12536 = (function (val,box,meta12537){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t12536.cljs$lang$type = true;
cljs.core.async.impl.channels.t12536.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t12536";
cljs.core.async.impl.channels.t12536.cljs$lang$ctorPrWriter = (function (this__3970__auto__,writer__3971__auto__,opt__3972__auto__){return cljs.core._write.call(null,writer__3971__auto__,"cljs.core.async.impl.channels/t12536");
});
cljs.core.async.impl.channels.t12536.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t12536.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12538){var self__ = this;
var _12538__$1 = this;return self__.meta12537;
});
cljs.core.async.impl.channels.t12536.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12538,meta12537__$1){var self__ = this;
var _12538__$1 = this;return (new cljs.core.async.impl.channels.t12536(self__.val,self__.box,meta12537__$1));
});
cljs.core.async.impl.channels.__GT_t12536 = (function __GT_t12536(val__$1,box__$1,meta12537){return (new cljs.core.async.impl.channels.t12536(val__$1,box__$1,meta12537));
});
}
return (new cljs.core.async.impl.channels.t12536(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_12539 = self__.takes.pop();if((taker_12539 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_12539))
{var take_cb_12540 = cljs.core.async.impl.protocols.commit.call(null,taker_12539);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_12540,taker_12539){
return (function (){return take_cb_12540.call(null,null);
});})(take_cb_12540,taker_12539))
);
} else
{}
{
