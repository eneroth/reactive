...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_12495 = 0;while(true){
if((i_12495 < arr.length))
{(arr[i_12495] = null);
{
...
{var i_12502 = (self__.level + 1);while(true){
if((i_12502 <= (new_level + 1)))
{(update[i_12502] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_12504 = 0;while(true){
if((i_12504 <= self__.level))
{var links_12505 = (update[i_12504]).forward;if(((links_12505[i_12504]) === x__$1))
{(links_12505[i_12504] = (x__$1.forward[i_12504]));
{
