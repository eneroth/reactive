...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_12530 = 0;while(true){
var m_12531 = cljs.core.async.impl.dispatch.tasks.pop();if((m_12531 == null))
{} else
{m_12531.call(null);
if((count_12530 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__12532 = (count_12530 + 1);
count_12530 = G__12532;
continue;
}
} else
{}
